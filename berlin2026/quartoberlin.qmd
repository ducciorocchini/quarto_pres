...
![](images/basics_era_tiergarten.png){fig-align="center"}

## Google Earth Engine

::: {style="text-align: center;"}
![](../images/gee.png){fig-align="center" width="80%"}
:::
...
## In-situ species richness

```{r sr, echo=T, eval=T}
plot(sd3, col = rev(viridis(100)))
pts <- spatSample(sd3, 22, method = "random", as.points = TRUE)
points(pts, pch = 16, col = "black", cex = 2)
```
...
![](../images/beta_diversity.png){width="80%\" align" fig-align="center"}

## Congo forest

![](../images/gee_congo.png){width="80%\" align" fig-align="center"}
...
library(terra)
library(imageRy)
pc <- im.pca(sentinel_congo)
plotRGB(pc, 1,2,3, stretch="hist")
```

![](images/congo_pca.png){width="80%\" align" fig-align="center"}

## In-situ sampling

``` r
pts <- spatSample(pc, 100, method = "random", as.points = TRUE)
points(pts, pch = 16, col = "black", cex = 0.6)
```

![](../images/insitu.png){width="80%\" align" fig-align="center"}

## Accumulation curves

![](images/rarefaction.png){width="80%\" align" fig-align="center"}

## Spectral species

![](images/spectral_species_chat.png){width="80%\" align" fig-align="center"}
...
::: {style="text-align: center;"}
![](../images/alien_daltonic.png){align="center" width="90%"}
:::

## Empirical result

::: {style="text-align: center;"}
![](../images/rasterdiv_strict_highres2.png){align="center" width="60%"}
:::
...
::: incremental
- **Spectral variability** is an observable imprint of **ecological structure** and **processes**  
- **Space** and **time** are not noise, but essential dimensions of **biodiversity**  
- **Models** help disentangle **neutral dynamics** from **environmental constraints**  
- **Open, reproducible workflows** are key to **inclusive** and **scalable biodiversity science**
:::

## A coding friend

::: {style="text-align: center;"}
![](images/r_coding.jpeg){align="center" fig-align="center" width="35%"}
:::
